<nav class="bg-white border-gray-200 dark:bg-gray-900 relative">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {{-- Search and Cart for Desktop, Cart and Menu Toggle for Mobile --}}
        <div class="flex md:order-2 items-center">
            {{-- Search Input for Desktop --}}
            <div class="relative hidden md:block me-4">
            ...
            {{-- Shopping Cart --}}
            <a href="{{ route('cart') }}" class="relative me-4">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
            ...
            <ul
                ...
                <li>
                    <a href="{{ route('home') }}"
                        class="block py-2 px-3 {{ request()->routeIs('home') ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500' : 'text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent' }}">
                        Home
                    </a>
                </li>
                ...
                {{-- Dropdown --}}
                <li class="relative">
                    <button data-dropdown-toggle="dropdown-navbar"
                    ...
                    <div id="dropdown-navbar"
                        class="absolute z-50 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
