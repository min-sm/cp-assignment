                ...
                <div class="lg:col-span-2 space-y-4">
                    <div class="p-6 bg-white shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] rounded-md relative">
                        <div class="flex items-center max-sm:flex-col gap-4 max-sm:gap-6">
                            ...
                            <div class="sm:border-l sm:pl-4 sm:border-gray-300 w-full">
                                <h3 class="text-lg font-bold text-gray-800">HP ProBook 455 (15.6) 39.6 cm G9 Business Laptop
                                </h3>
                                ...
                                <ul class="mt-4 text-sm text-gray-500 space-y-2">
                                    ...
                                    <li><a href="javascript:void(0);" class="text-blue-600">(See more Specifications)</a>
                                    </li>
                    ...
                    <div class="p-6 bg-white shadow-[0_0px_4px_0px_rgba(6,81,237,0.2)] rounded-md relative">
                        <div class="flex items-center max-sm:flex-col gap-4 max-sm:gap-6">
                            ...
                            <div class="sm:border-l sm:pl-4 sm:border-gray-300 w-full">
                                <h3 class="text-lg font-bold text-gray-800">ThinkPad E16 40.64cms - 13th Gen Intel i5</h3>
