                ...
                <div class="flex flex-wrap -m-4">
                    <div class="p-4 md:w-1/2 w-full">
                        <div class="h-full bg-gray-100 p-8 rounded">
                            ...
                            <p class="leading-relaxed mb-6">The retail store exceeded my expectations! Staff was
                    ...
                    <div class="p-4 md:w-1/2 w-full">
                        <div class="h-full bg-gray-100 p-8 rounded">
                            ...
                            <p class="leading-relaxed mb-6">Amazing shopping experience! The store's atmosphere was
